...
@Component({
  selector: 'app-uk-public',
  templateUrl: './uk-public.component.html',
  styleUrls: ['./uk-public.component.css', '../new-number/new-number.component.css']
})
export class UkPublicComponent implements OnInit {
	...
	updateDataSourceValue() {
		this.userData.telephonetype = 'ukpublic';
